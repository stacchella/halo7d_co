...
### Job name
#SBATCH -J 'nonsfhshalo7d'
### output and error logs
#SBATCH -o nonsfhshalo7d_%a.out
#SBATCH -e nonsfhshalo7d_%a.err
### mail
#SBATCH --mail-type=END
#SBATCH --mail-user=sandro.tacchella@cfa.harvard.edu
source activate pro
srun -n 1 python /n/conroyfs1/stacchella/halo7d_co/runs/param_file_sfh_small.py \
--objid="${SLURM_ARRAY_TASK_ID}" \
--outfile="halo7d_nonparametric_sfh_small" \
