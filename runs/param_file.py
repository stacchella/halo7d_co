...
def read_results(filename):
    ...
    res['run_params']['init_run_file'] = path_wdir + '/results/param_init/posterior_draws/summary_param_init_run.pkl'
    res['run_params']['path_files_init_run'] = path_wdir + '/results/param_init/'
